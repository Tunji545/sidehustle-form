...
const checkPassword = () => {
  ...
  if(!isRequired(password)) {
    ...
    showError(passwordEl,  "Password must has at least 8 characters that includes 1 lowercase character, 1 uppercase character, 1 number and 1 special character in ('!@#$%^&*')");
  } else {
